...
void run_Smithy(struct gameState *state, int handPos, int currentPlayer)
{
  int i;
...
void run_council_room(struct gameState *state, int currentPlayer, int handPos)
{
  int i;
...
int run_Remodel(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos)
{
  int i;
  int j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
	run_Adventurer(state);
        return 0;
			
    case council_room:
	run_council_room(state, currentPlayer, handPos);
        return 0;
    ...
    case remodel:
      return run_Remodel(state, currentPlayer, choice1, choice2, handPos);
      return 0;
		
    case smithy:
      run_Smithy(state, handPos, currentPlayer);
      return 0;
    ...
    case minion:
      run_Minion(state, handPos, currentPlayer, choice1, choice2);
      return 0;
